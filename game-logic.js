...
function isInRenderHorizon(q, r) {
    const RENDER_HORIZON = window.RENDER_HORIZON;
...
if (typeof window !== 'undefined') {
    ...
    window.getLineInDirection = getLineInDirection;
    window.checkThreat = checkThreat;
    window.rebuildGameState = rebuildGameState;
    window.isInRenderHorizon = isInRenderHorizon;
    window.buildLine = buildLine;
}
